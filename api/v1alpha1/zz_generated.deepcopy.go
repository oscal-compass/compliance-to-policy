...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CheckPolicyObjectTemplate) DeepCopyInto(out *CheckPolicyObjectTemplate) {
	*out = *in
...
func (in *CheckPolicyObjectTemplate) DeepCopy() *CheckPolicyObjectTemplate {
	if in == nil {
		return nil
	}
	out := new(CheckPolicyObjectTemplate)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CheckPolicySpec) DeepCopyInto(out *CheckPolicySpec) {
	*out = *in
	if in.ObjectTemplates != nil {
		...
		*out = make([]CheckPolicyObjectTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ComplianceReport) DeepCopyInto(out *ComplianceReport) {
	*out = *in
	...
	if in.Results != nil {
		...
		*out = make([]ComplianceReportResult, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ComplianceReportCluster) DeepCopy() *ComplianceReportCluster {
	if in == nil {
		return nil
	}
	out := new(ComplianceReportCluster)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComplianceReportResult) DeepCopyInto(out *ComplianceReportResult) {
	*out = *in
	...
	if in.Clusters != nil {
		...
		*out = make([]ComplianceReportCluster, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComplianceReportResult.
func (in *ComplianceReportResult) DeepCopy() *ComplianceReportResult {
	if in == nil {
		return nil
	}
	out := new(ComplianceReportResult)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComplianceReportSummary) DeepCopy() *ComplianceReportSummary {
	if in == nil {
		return nil
	}
	out := new(ComplianceReportSummary)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ControlReferenceKcpSpec) DeepCopyInto(out *ControlReferenceKcpSpec) {
	*out = *in
	...
	in.ComplianceDeployment.DeepCopyInto(&out.ComplianceDeployment)
	if in.Summary != nil {
...
func (in *PolicyValidationRequest) DeepCopy() *PolicyValidationRequest {
	if in == nil {
		return nil
	}
	out := new(PolicyValidationRequest)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResultCollectorSpec) DeepCopyInto(out *ResultCollectorSpec) {
	*out = *in
	in.ComplianceDeployment.DeepCopyInto(&out.ComplianceDeployment)
	if in.PolicyValidationRequests != nil {
		in, out := &in.PolicyValidationRequests, &out.PolicyValidationRequests
		*out = make([]PolicyValidationRequest, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
