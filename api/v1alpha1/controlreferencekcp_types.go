...
type ControlReferenceKcpTarget struct {
...
type ControlReferenceKcpSpec struct {
	...
	Target ControlReferenceKcpTarget `json:"target,omitempty"`
...
func init() {
	SchemeBuilder.Register(&ControlReferenceKcp{}, &ControlReferenceKcpList{})
}
